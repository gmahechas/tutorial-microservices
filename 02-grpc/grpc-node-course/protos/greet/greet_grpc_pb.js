...
var protos_greet_greet_pb = require('../../protos/greet/greet_pb.js');

function serialize_greet_GreetRequest(arg) {
  if (!(arg instanceof protos_greet_greet_pb.GreetRequest)) {
...
function deserialize_greet_GreetRequest(buffer_arg) {
  return protos_greet_greet_pb.GreetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_GreetResponse(arg) {
  if (!(arg instanceof protos_greet_greet_pb.GreetResponse)) {
...
function deserialize_greet_GreetResponse(buffer_arg) {
  return protos_greet_greet_pb.GreetResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
greet: {
    ...
    requestType: protos_greet_greet_pb.GreetRequest,
    responseType: protos_greet_greet_pb.GreetResponse,
